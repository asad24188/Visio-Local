...
class PreviousCollectionsAdapter(val context: Context, val list: List<LocalCollection>) :
    RecyclerView.Adapter<PreviousCollectionsAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return PreviousCollectionsAdapter.ViewHolder(view)
    }
